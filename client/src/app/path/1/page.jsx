...
const images = [
  // Front
  { position: [0, 0, 1.5], rotation: [0, 0, 0], url: pexel(1103970), link: "https://github.com/Dearborn42/FBLA-App" },
  // Back
  { position: [-0.8, 0, -0.6], rotation: [0, 0, 0], url: pexel(416430), link: "https://github.com/Dearborn42/mern-blueprint" },
  { position: [0.8, 0, -0.6], rotation: [0, 0, 0], url: pexel(310452), link: "https://scurtisphd.com/home" },
  // Left

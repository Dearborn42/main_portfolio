...
export function GithubPage(){
  ...
  return (
    <group ref={group} position={[100, 0, 0]} dispose={null}>
      <group rotation-x={-0.425} pposition={[100, 0, 0]}>
        <group position={[100, 0, 0]} rotation={[Math.PI / 2, 0, 0]}>
          <mesh geometry={nodes['Cube008_2'].geometry} position={[100, 0, 0]} scale={[100, 100, 100]}>
            {/* Drei's HTML component can "hide behind" canvas geometry */}
            <Html className="content" rotation-x={-Math.PI / 2} position={[100, 0, 0]} scale={[100, 100, 100]} transform occlude>
